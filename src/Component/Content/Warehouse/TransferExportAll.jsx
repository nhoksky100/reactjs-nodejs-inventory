...
class TransferExportAll extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataTeamp: null,
                ...
                <div className="order">
                    ...
                    <div className="head">
                        ...
                        </div>
                        {
                            ...
                            <div style={{ marginRight: '25px' }} className='view-approved' >
...
export default connect(mapStateToProps, mapDispatchToProps)(TransferExportAll)